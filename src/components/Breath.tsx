                    ...
                    <Grid item xs={12} md={7}>
                        <Grid container direction="column" spacing={2}>
                            ...
                            <Grid item sx={{ height: '40%', marginBottom: "20px" }}>
                                <Box>
                                    <h1 style={{ fontSize: '6rem', fontWeight: 700, color: '#090F09', }}>Breath</h1>
                                    <p style={{ fontSize: '1.5rem', fontWeight: 400, color: '#434943', }}>Find Harmony in Nature with our mindfulness retreats.</p>
                                </Box>
                            </Grid>
                            {/* Bottom Left box */}
                        ...
                        <Grid container direction="column" spacing={2}>
                            ...
                            <Grid item sx={{ height: '70%' }}>
                                <Box sx={{paddingX: "20px"}}>
                                    <h2 style={{ fontSize: '3rem', fontWeight: 700, color: '#090F09', }}>The Project</h2>
                                    <p style={{ fontSize: '1.2rem', fontWeight: 400, color: '#434943', }}>Breath is a tranquil retreat deeply rooted in nature, offering a sanctuary for wellness and self-discovery.
                                    <br />
                                    <br />
